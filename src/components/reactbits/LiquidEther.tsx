...
export default function LiquidEther({
  ...
  const defaultColors = useMemo(() => ["#5227FF", "#FF9FFC", "#B19EEF"], []);
  const colorStopsKey = colorsProp ? colorsProp.join(",") : "default";
  const paletteColors = useMemo(() => colorsProp ?? defaultColors, [colorStopsKey, defaultColors]);
  ...
  gl_Position = vec4(pos, 1.0);
    ...
    class ShaderPass {
      ...
      plane: THREE.Mesh<THREE.BufferGeometry, THREE.RawShaderMaterial> | null = null;
    ...
    class Advection extends ShaderPass {
      uniforms: any;
      line: THREE.LineSegments<THREE.BufferGeometry, THREE.RawShaderMaterial> | null = null;
    ...
    class ExternalForce extends ShaderPass {
      mouse: THREE.Mesh<THREE.PlaneGeometry, THREE.RawShaderMaterial> | null = null;
  ...
  const combinedClassName = ["liquid-ether-container", className].filter(Boolean).join(" ");

  return <div ref={mountRef} className={combinedClassName} style={style} />;
}
