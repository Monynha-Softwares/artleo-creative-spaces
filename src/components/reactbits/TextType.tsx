...
type TextTypeProps<T extends keyof JSX.IntrinsicElements> = {
  text: string | string[];
  as?: T;
  typingSpeed?: number;
  initialDelay?: number;
...
export const TextType = <T extends keyof JSX.IntrinsicElements = "div">({
  text,
  ...
  useEffect(() => {
    if (!startOnVisible || !containerRef.current || typeof IntersectionObserver === "undefined") {
      return;
    }
